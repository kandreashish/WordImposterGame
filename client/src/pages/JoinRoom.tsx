  ...
  return (
    <div className="min-h-screen game-bg-radial flex flex-col items-center justify-start md:justify-center p-4 relative overflow-x-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        <Link to="/" onClick={() => trackEvent('click_back_to_home_nav', { screen: 'JoinRoom' })} className="inline-flex items-center gap-2 text-xs font-semibold text-slate-500 hover:text-slate-700 dark:text-slate-400 dark:hover:text-slate-200 transition-colors uppercase tracking-wider mb-4 group">
