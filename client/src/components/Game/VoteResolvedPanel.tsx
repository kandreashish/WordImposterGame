...
export const VoteResolvedPanel: React.FC = () => {
  ...
  return (
    <div className="flex flex-col gap-6 w-full max-w-xl mx-auto">
      ...
      <Card className="text-center py-6 border-slate-800 bg-slate-900/40 relative overflow-hidden">
        ...
        {candidate ? (
          ...
          <>
            <ShieldAlert className="text-amber-400 w-12 h-12 mx-auto mb-3" />
      ...
      {isHost ? (
        <Card className="p-5 border-slate-800 bg-slate-950/40 flex flex-col gap-3">
          <span className="text-3xs font-extrabold text-violet-400 uppercase tracking-widest block mb-1 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <Button
              ...
              className="flex-1 gap-2 border-slate-800"
            >
              <RefreshCw size={16} />
              One More Clue Round
            </Button>
        ...
        <Card className="py-5 border-slate-800 bg-slate-950/20 text-center flex flex-col items-center justify-center gap-2 select-none">
          <Hourglass size={20} className="text-slate-500 animate-spin" />
          <span className="text-3xs font-bold text-slate-500 uppercase tracking-widest">
            Waiting for Host to decide
          </span>
          <p className="text-4xs text-slate-600 font-medium">
      ...
      <Card className="p-4 border-slate-800 bg-slate-950/40">
        <span className="text-2xs font-extrabold text-slate-500 uppercase tracking-widest block mb-3 border-b border-slate-900 pb-2">
          Cast Votes Log
        </span>
